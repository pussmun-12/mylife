...
( function( $, window, undefined ) {
    ...
    $.Calendario.defaults = {
        ...
        weekabbrs : [ 'Sön', 'Mån', 'Tis', 'Ons', 'Tor', 'Fre', 'Lör' ],
    ...
    $.Calendario.prototype = {
        ...
        _init : function( options ) {
            ...
            this.angularScope = this.options.angularScope;
            this.today = this.options.today || new Date();
            this.month = ( isNaN( this.options.month ) || this.options.month == null) ? this.today.getMonth() : this.options.month - 1;
            this.year = ( isNaN( this.options.year ) || this.options.year == null) ? this.today.getFullYear() : this.options.year;
            //  console.log("HÄR: " + this.month + ' ' + this.year);
            //this.date =
        ...
        _getBody : function() {
            ...
            for ( var i = 0; i < 7; i++ ) {
                ...
                for ( var j = 0; j <= 6; j++ ) {
                    //måste ha tillgång till scope.datesHavingText här!
                    var isoDate = this.year + "-" + (currentMonth < 10 ? "0" + currentMonth: currentMonth) + "-" + (day < 10 ? "0" + day : day);
                    //var cellStyle = '';
                    var imgFound = false;
                    ...
                    var dateHavingText = this.angularScope.datesHavingText[isoDate];
                    if(dateHavingText){
                        if(dateHavingText.maintext){
                           maintextFound = true;
                        }
                    ...
                    else if(imgFound && maintextFound){
                        classy = 'maintextImgBorder';
                    }
                    else if(imgFound){
                        classy = 'imgBorder';
                    }
                    else if(maintextFound && factboxFound){
                        classy = 'factboxMaintextBorder';
                    }
                    else if(maintextFound){
                        classy = 'maintextBorder';
                    }
                    else if(factboxFound){
                    ...
                    if ( day <= monthLength && ( i > 0 || j >= p ) ) {
                        ...
                        inner += '<span class="fc-date ' + classy + '">' + day + '</span><span class="fc-weekday">' + this.options.weekabbrs[ j + this.options.startIn > 6 ? j + this.options.startIn - 6 - 1 : j + this.options.startIn ] + '</span>';
